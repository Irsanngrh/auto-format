...
<div class="d-flex align-items-center gap-3 mb-4">
    <div class="d-flex align-items-center text-secondary"><i class="bi bi-funnel-fill me-2"></i><span class="filter-label mb-0" style="font-weight: 700; font-size: 10px;">FILTER</span></div>
